...
class GameTest(unittest.TestCase):
    ...
    def testWhenPlayerPawnStepsOverBrotherPawnTheyBothStay(self):
        ...
        self.assertEqual(game.current_player._pawns[0], 31)
        self.assertEqual(game.current_player._pawns[1], 31)
        self.assertEqual(game._board[index], 'R2')

    def testWhenPawnStepsOverOtherPlayerPawnTheLastIsRemovedFromField(self):
        game = self.create_game()
